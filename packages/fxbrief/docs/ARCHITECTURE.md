...
`fx-brief` has two related pipelines.
...
This layer also handles partial quote bodies, tombstones, missing avatars, optional metrics, and media shape differences.
...
The four first-version templates are:
