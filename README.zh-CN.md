...
<img src="docs/assets/example-shanshui-landscape.jpg" width="520" alt="山水主题示例">
...
| Skill | 使用场景 | Prompt / Command | 结果 | 授权链路 |
| --- | --- | --- | --- | --- |
| `matt-pic-grab-image` | 中文关键词：山水 | `使用 $matt-pic-grab-image 给我一张“山水”主题图片，要求免费商用、无需署名、可二改` | <img src="docs/assets/example-shanshui-landscape.jpg" width="220" alt="山水主题示例"> | `CC0 / Public Domain`<br>The Metropolitan Museum of Art Open Access<br>`risk_flags: []` |
| `matt-pic-grab-image` | 历史题材封面 | `Use $matt-pic-grab-image to find a CC0 historical painting for a cover.` | <img src="docs/assets/example-history-socrates.webp" width="220" alt="历史题材示例"> | Openverse 元数据标记为 `CC0`<br>保留来源页用于复核 |
| `matt-pic-grab-image` | 随机自然背景 | `bun run pic:random` | <img src="docs/assets/example-mountain-landscape.jpg" width="220" alt="自然背景示例"> | Openverse 元数据标记为 `CC0`<br>本地图片和元数据已保存 |
