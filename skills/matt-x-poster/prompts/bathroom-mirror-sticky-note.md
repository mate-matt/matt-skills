...
- Treat the avatar circle as a protected flat bitmap island and small circular printed decal / original-bitmap sticker. Bathroom light, mirror reflections, fog, tape shine, and water droplets may surround the avatar, but they must not pass through, recolor, blur, warp, relight, or repaint the avatar interior.
- Keep the avatar a compact UI identity marker inside the X author/profile row or small source card, roughly 6-10% of the main source-card width when possible. It should never become the poster's main portrait.
