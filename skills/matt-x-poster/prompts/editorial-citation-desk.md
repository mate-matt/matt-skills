...
- Treat the avatar circle as a protected flat bitmap island and small circular printed decal / original-bitmap sticker on the citation/source card. Paper fibers, page curvature, hand shadows, ink texture, desk glare, and folds may surround it, but they must not enter, recolor, blur, warp, relight, or repaint the avatar interior.
- Keep the avatar a compact UI identity marker inside the author/profile row, roughly 6-10% of the citation/source-card width when possible. It must remain secondary to the exact citation text and media.
